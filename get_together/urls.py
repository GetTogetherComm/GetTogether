...
urlpatterns = [
    ...
    path(
        ...
        name="setup-1-confirm-profile",
    ),
    path(
        "profile/+pick_categories",
        views.setup_2_pick_categories,
        name="setup-2-pick-categories",
    ),
    path("profile/+find_teams", views.setup_3_find_teams, name="setup-3-find-teams"),
    path(
        "profile/+attend_events",
        views.setup_4_attend_events,
        name="setup-4-attend-events",
    ),
    path("profile/+setup_complete", views.setup_complete, name="setup-complete"),
    path("profile/+edit", views.edit_profile, name="edit-profile"),
    path(
        "profile/+send_confirmation_email",
        views.user_send_confirmation_email,
        name="send-confirm-email",
    ),
    path(
        "profile/+confirm_email/<str:confirmation_key>",
        views.user_confirm_email,
        name="confirm-email",
    ),
    path(
        "profile/+confirm_notifications",
        views.user_confirm_notifications,
        name="confirm-notifications",
    ),
    path("profile/<int:user_id>/", views.show_profile, name="show-profile"),
    path(
        "profile/<str:account_secret>.ics",
        feeds.UserEventsCalendar(),
        name="user-event-ical",
    ),
    ...
    path(
        "speaker/<int:speaker_id>/+delete", views.delete_speaker, name="delete-speaker"
    ),
    ...
    path(
        "team/<int:team_id>/+change_role/<int:profile_id>/",
    ...
    path(
        "team/+create-event/",
        views.create_event_team_select,
        name="create-event-team-select",
    ),
    ...
    path(
        "events/<int:event_id>/+new-event-place/",
        views.new_event_add_place,
        name="new-event-add-place",
    ),
    path(
        "events/<int:event_id>/+new-event-details/",
        views.new_event_add_details,
        name="new-event-add-details",
    ),
    path(
        "events/<int:event_id>/+new-event-team/",
        views.new_event_add_team,
        name="new-event-add-team",
    ),
    ...
    path(
        "events/<int:event_id>/+attended/", views.attended_event, name="attended-event"
    ),
    path(
    ...
    path(
        "events/<int:event_id>/+add_place/", views.add_place_to_event, name="add-place"
    ),
    ...
    path(
        "comment/<int:comment_id>/+delete/", views.delete_comment, name="comment-delete"
    ),
    path(
        "events/<int:event_id>/+photo/", views.add_event_photo, name="add-event-photo"
    ),
    path(
        "photo/<int:photo_id>/+remove/",
        views.remove_event_photo,
        name="remove-event-photo",
    ),
    path(
        "events/<int:event_id>/+propose-talk/",
        views.propose_event_talk,
        name="propose-event-talk",
    ),
    path(
        "events/<int:event_id>/+schedule-talks/",
        views.schedule_event_talks,
        name="schedule-event-talks",
    ),
    path(
    ...
    path(
        "series/<int:series_id>/+add_place/",
        views.add_place_to_series,
        name="add-place-to-series",
    ),
    path(
        "series/<int:series_id>/<str:series_slug>/",
        views.show_series,
        name="show-series",
    ),
    ...
    path(
        "team/<int:team_id>/+invite_to_join_org/",
        views.invite_to_join_org,
        name="invite-to-join-org",
    ),
    path(
        "org/invite/<int:invite_id>/+resend/",
        views.resend_org_invite,
        name="resend-org-invite",
    ),
    path(
        "org/<str:org_slug>/+request_to_join_org/",
        views.request_to_join_org,
        name="request-to-join-org",
    ),
    path(
        "org/+confirm_request/<str:request_key>/",
        views.confirm_request_to_join_org,
        name="confirm-request-to-join-org",
    ),
    path(
        "org/<str:org_slug>/+manage_teams/", views.manage_org_teams, name="manage-teams"
    ),
    path(
        "org/<str:org_slug>/+create-event/",
        views.create_common_event,
        name="create-common-event",
    ),
    path(
        "common/<int:event_id>/+create-event/",
        views.create_common_event_team_select,
        name="create-common-event-team-select",
    ),
    path(
        "common/<int:event_id>/+edit/",
        views.edit_common_event,
        name="edit-common-event",
    ),
    path(
        "common/<int:event_id>/<str:event_slug>/",
        views.show_common_event,
    ...
    path(
        "<str:team_slug>/about/",
        views.show_team_about_by_slug,
        name="show-team-about-by-slug",
    ),
    path(
        "<str:team_slug>/events/",
